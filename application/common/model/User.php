...
class User extends Base
{
    ...
    public function register($param)
    {
        ...
        $uid = $param['uid'];
        $is_from_3rdparty = !empty($param['user_openid_qq']) || !empty($param['user_openid_weixin']) || !empty($param['user_openid_google']) || !empty($param['user_openid_facebook']);
        ...
        $fields['user_openid_google'] = (string)$param['user_openid_google'];
        $fields['user_openid_facebook'] = (string)$param['user_openid_facebook'];
    ...
    public function login($param)
    {
        ...
        if (empty($data['openid'])) {
            ...
            if (!in_array($data['col'], ['user_openid_qq', 'user_openid_weixin', 'user_openid_google', 'user_openid_facebook'])) {
