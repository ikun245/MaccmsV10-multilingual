...
https://www.baidu.com/123.jpg
    ...
    //custom
    'maccms_name'=>'AKG建站服务',
    'maccms_copyright'=>'© <a href="https://t.me/AKG_Group" target="_blank">AKG建站服務 t.me/AKG_Group</a>',
    'admin/public/head/title'=>'AKG建站服務',
    'admin/index/login/title'=>'後台管理中心 - Copyright by AKG建站服務內容管理系統',
    'admin/index/index/name' =>'AKG建站服务',
    'install/title'=>'AKG建站服務',
    'install/header'=>'感謝您選擇AKG建站服務',
    'install/user_agreement_title'=>'AKG建站服務用戶協議 適用於所有用戶',
    'install/user_agreement'=>' 請您在使用(AKG建站服務)前仔細閱讀如下條款。包括免除或者限制作者責任的免責條款及對用戶的權利限制。您的安裝使用行為將視為對本《用戶許可協議》的接受，並同意接受本《用戶許可協議》各項條款的約束。 <br /><br />
                一、免責聲明：  <br />
                ...
                二、協議規定的約束和限制：  <br />
                禁止去除(AKG建站服務)源碼裏的版權信息，商業授權版本可去除後台界面及前台界面的相關版權信息。</br>
                禁止在(AKG建站服務)整體或任何部分基礎上發展任何派生版本、修改版本或第三方版本用於重新分發。',
    'install/is_ok'=>'系統安裝成功，歡迎您使用AKG建站服務建站',
