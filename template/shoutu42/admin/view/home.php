				...
				<form class="layui-form" method="post" action="?url=home&array=index&type=post" enctype="multipart/form-data">
                    ...
                    <fieldset class="layui-elem-field footer">
                        <div class="layui-form-item">
                            ...
                            <button type="button" class="layui-btn layui-btn-primary layer-confirm" data-url="<?php echo $href;?>type=empty" data-msg="您确定要进行清空操作吗？该操作不可撤销！">清空设置</button>
